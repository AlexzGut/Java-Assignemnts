...
public class Assignment_2 {
	...
	public static void main(String[] args) throws IOException {  
		...
		PrintWriter outputFile = new PrintWriter("src\\com\\lcit\\assignments\\Paystyb.txt");		
		...
		System.out.printf(OUTPUT, "Will", "347 Lawson Rd, Scarborough, ON",
								   ...
								   hoursWorked + holidays + bonusHours, earnings,
								   ccpTax,
								   eiTax,
								   federalTax,
								   netPay);
		
		outputFile.printf(OUTPUT, "Will", "347 Lawson Rd, Scarborough, ON",
				   hoursWorked, SOLO_PAY_RATE, regularPay,
				   bonusHours, SOLO_PAY_RATE, bonusPay,
				   holidays, HOLIDAY_PAY, holidaysPay,
